...
# プロンプトタイプ("rinna","vicuna","alpaca","llama2","beluga","ja-stablelm","stablelm","redpajama","falcon","line","weblab","mixtral","swallow","nekomata","elyzallama2","chatml","qa","none")
PROMPT_TYPE = "rinna"
...
parser.add_argument("--prompt-type", type=str, choices=["rinna", "vicuna", "alpaca", "llama2", "beluga", "ja-stablelm", "stablelm", "redpajama", "falcon", "xgen", "weblab", "mixtral", "swallow", "nekomata", "elyzallama2", "chatml", "qa", "none"], default=PROMPT_TYPE, help="プロンプトタイプ名")
